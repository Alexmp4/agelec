...
class Elementor_Control_Icon extends Elementor\Base_Control {
	...
	public static function get_icons() {
		return [
	        ...
	        'icon2-home-5' => 'home 5',
	        'icon2-home-6' => 'home 6',
	        'icon2-home-circled' => 'home circled',
	        'icon2-graduation-cap' => 'graduation cap',
	        'icon2-wifi-outline' => 'graduation cap',
			'icon2-wifi' => 'wifi',
			'icon2-desktop-1' => 'desktop',
			'icon2-laptop-1' => 'laptop',
			'icon2-tablet-1' => 'tablet',
			'icon2-mobile-2' => 'mobile',
			'icon2-tools' => 'tools',
			'icon2-lifebuoy' => 'lifebuoy',
	    ];
	}
...
add_action( 'elementor/editor/after_enqueue_scripts', function() {
    ...
    wp_enqueue_style( 'fontello', plugin_dir_url( __FILE__ ) . 'style.css' );
});
...
function icons_enqueue_after_frontend() {
    ...
    wp_enqueue_style( 'fontello', plugin_dir_url( __FILE__ ) . 'style.css' , array(), PLUG_VERSION);
}
