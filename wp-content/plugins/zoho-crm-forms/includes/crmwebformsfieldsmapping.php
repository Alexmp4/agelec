...
class zcffieldlistDatamanage {
    ...
    function zcffieldsPropsettings($crmtype, $module, $layoutname) {
        global $wpdb;
        $fields = $wpdb->get_results("select *from zcf_zohocrmform_field_manager where crm_type = '" . $crmtype . "' and module_type = '" . $module . "' and Layout_Name = '" . $layoutname . "' and readonly != '1' and field_name !='Layout' and  viewcreate_type != '0' and field_type NOT IN ('lookup','ownerlookup','multiselectlookup')");
        return $fields;
    }
