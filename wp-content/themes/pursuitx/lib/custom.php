...
function th_masterslider_update_check() {
    ...
    if ( is_dir( $th_plugin_dir ) ) {
        ...
        $myUpdateChecker = Puc_v4_Factory::buildUpdateChecker(
            'http://import.themovation.com/live-plugin-updater/masterslider.json',
...
function themo_ot_meta_box_post_format_link($array,$pages) {
	...
	$array['fields'] = array(
		...
		/*array(
			...
			'label'       => esc_html__( 'Link behaviour on the portfolio homepage', 'pursuit' ),
...
function th_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
            ...
            'source'    => 'https://www.dropbox.com/s/bgskomhpnstkj11/master-slider.zip?dl=1', //get_template_directory() . '/plugins/th-widget-pack.zip', // The plugin source.
            'recommended' => true,
		),
		array(
	...
	$config = array(
		...
		/*
		'strings'      => array(
			'page_title'                      => __( 'Install Required Plugins', 'pursuit' ),
			'menu_title'                      => __( 'Install Plugins', 'pursuit' ),
			/* translators: %s: plugin name. * /
			'installing'                      => __( 'Installing Plugin: %s', 'pursuit' ),
			/* translators: %s: plugin name. * /
			'updating'                        => __( 'Updating Plugin: %s', 'pursuit' ),
			'oops'                            => __( 'Something went wrong with the plugin API.', 'pursuit' ),
			...
			'return'                          => __( 'Return to Required Plugins Installer', 'pursuit' ),
			'plugin_activated'                => __( 'Plugin activated successfully.', 'pursuit' ),
			'activated_successfully'          => __( 'The following plugin was activated successfully:', 'pursuit' ),
			/* translators: 1: plugin name. * /
			'plugin_already_active'           => __( 'No action taken. Plugin %1$s was already active.', 'pursuit' ),
			/* translators: 1: plugin name. * /
			'plugin_needs_higher_version'     => __( 'Plugin not activated. A higher version of %s is needed for this theme. Please update the plugin.', 'pursuit' ),
			/* translators: 1: dashboard link. * /
			'complete'                        => __( 'All plugins installed and activated successfully. %1$s', 'pursuit' ),
			'dismiss'                         => __( 'Dismiss this notice', 'pursuit' ),
			'notice_cannot_install_activate'  => __( 'There are one or more required or recommended plugins to install, update or activate.', 'pursuit' ),
			'contact_admin'                   => __( 'Please contact the administrator of this site for help.', 'pursuit' ),
